...
{
    //This is a coppied Boids script ajusted for the new behavoirs 
  ...
  //  public float height = 3f; 
    ...
    void Awake()
    {
        ...
        else
        {
          ...
          transform.position = new Vector3 (transform.position.x, 4f, transform.position.z);
            ...
            //SPawning pramiters are set

            //Set a random initial velocity
            Vector3 vel = Random.onUnitSphere * Spawner.S.velocity;

            vel.y = 0f; 
            //stopping vertical moment, so the parmiters set in spawn remain 
            rigid.velocity = vel;
            ...
            {
                r.material.color = new Color(160, 32, 420);
                //This recolors each of the Burbs. 
            }
    ...
    private void FixedUpdate()
    {
        ...
        else
        {
            ...
            pos.Set(transform.position.x, 4f, transform.position.z);
            rigid.velocity = vel;
    ...
    public void OnRenderObject()
    {
        if(IsNotBurb == true)
        {
            //Can't have the obsticals haveing lines can we?
        }
        else
        {
            // Draw lines
            ...
            //  Prop.transform.position = pos + rotVec2;
